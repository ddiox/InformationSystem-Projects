...
import com.example.sisteminformasi.user.UserDetailActivity;

import java.util.List;

public class RequestUserAdapterRecyclerView extends RecyclerView.Adapter<RequestUserAdapterRecyclerView.MyViewHolder> {
    ...
    public RequestUserAdapterRecyclerView(List<Requests> moviesList, Activity activity) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.rl_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent goDetail = new Intent(mActivity, UserDetailActivity.class);
